    ...
    for batch_size in batch_sizes:
        for learning_rate in learning_rates:
            for init_method in init_methods:
                ...
                print(f"Batch Size: {batch_size}, Learning Rate: {learning_rate}, Initialization Method: {init_method}")
                ...
                if loss < best_loss:
                    best_loss = loss
                    best_W = W
                    best_params = (batch_size, learning_rate, init_method)
    
    elapsed_time = time.time() - start_time
    print(f"Best Parameters: Batch Size: {best_params[0]}, Learning Rate: {best_params[1]}, Initialization Method: {best_params[2]}")
