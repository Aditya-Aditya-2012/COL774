...
if __name__ == '__main__':
    your_weights_file = ""  #Add path to your weights.pkl here for a particular epoch.
    GT_weights_file = "" #Add path to the given weights.pkl here for a particular epoch to be used for comparison.
